...
GPIO_Init(GPIOB,&GPIO_InitStructure);
 ...
 //PB0 PB1    TIM3 输入口
 GPIO_InitStructure.GPIO_Pin = GPIO_Pin_0 | GPIO_Pin_1 | GPIO_Pin_3 | GPIO_Pin_4 | GPIO_Pin_14 ;
 GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IPU;
 GPIO_Init(GPIOB,&GPIO_InitStructure);
...
// 输入
 GPIO_InitStructure.GPIO_Pin = GPIO_Pin_5 | GPIO_Pin_6 | GPIO_Pin_8 | GPIO_Pin_9 | GPIO_Pin_10 | GPIO_Pin_11;
 GPIO_InitStructure.GPIO_Mode =  GPIO_Mode_IPU;
 GPIO_Init(GPIOD,&GPIO_InitStructure);   
...
// 步进电机控制  输出
 GPIO_InitStructure.GPIO_Pin =   GPIO_Pin_0 | GPIO_Pin_1 | GPIO_Pin_2 | GPIO_Pin_3 | GPIO_Pin_4 | GPIO_Pin_5 | GPIO_Pin_6 | GPIO_Pin_7 | GPIO_Pin_8 | GPIO_Pin_10 | GPIO_Pin_12 | GPIO_Pin_15;
 GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
 //GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;
...
void  Init_Tim2 (void)
{
    ...
    TIM_TimeBaseStructure.TIM_Period        = 20;//50;  //50us

    
                
    TIM_TimeBaseStructure.TIM_Prescaler     = 71;//71;//71;	//72分频
